...
@property (retain,nonatomic) NSMutableArray* settingSource;
...
//    titleArray = [[NSArray alloc]initWithObjects:@"系统设置",@"上传下载模块信息",@"模块设置", nil];
    ...
    NSArray* array1 = [[[NSArray alloc]initWithObjects:@"更新版本",@"setting_update.png", nil]autorelease];
    NSArray* array2 = [[[NSArray alloc]initWithObjects:@"关于我们",@"setting_about.png", nil]autorelease];
    NSArray* array3 = [[[NSArray alloc]initWithObjects:@"即时通讯",@"setting_about.png", nil]autorelease];
    ...
    NSArray* array_1 = [[[NSArray alloc]initWithObjects:@"上传",@"setting_about.png", nil]autorelease];
    NSArray* array_2 = [[[NSArray alloc]initWithObjects:@"下载",@"setting_update.png", nil]autorelease];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0 ) {
        if (indexPath.row == 0 ) {
            ...
            [setttingIMViewController release];
        }
    }
