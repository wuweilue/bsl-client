...
@property (strong,nonatomic) NSMutableArray *resortedArray;
...
- (void)viewDidLoad
{
    ...
    self.resortedArray = [[NSMutableArray alloc] initWithCapacity:20];
    [self inverseArray];
    ...
    [self.navigationItem setRightBarButtonItem:[[UIBarButtonItem alloc] initWithTitle:@"清空" style:UIBarButtonItemStyleBordered target:self action:@selector(removeAllData)]];
