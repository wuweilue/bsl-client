...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        bottomRightView.center = CGPointMake(_ScreenWidth - 10, self.frame.size.height - bottomRightView.frame.size.height - SpiralPullToRefreshViewParticleSize);
        ...
        bottomCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - bottomCenterView.frame.size.height);
        ...
        middleLeftView.center = CGPointMake(_ScreenWidth - 10, self.frame.size.height - middleLeftView.frame.size.height - SpiralPullToRefreshViewParticleSize);
        ...
        middleRightView.center = CGPointMake(_ScreenWidth - 10, self.frame.size.height - middleRightView.frame.size.height - SpiralPullToRefreshViewParticleSize);
        ...
        middleCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - middleCenterView.frame.size.height);
        ...
        topLeftView.center = CGPointMake(_ScreenWidth - 10, self.frame.size.height - topLeftView.frame.size.height - SpiralPullToRefreshViewParticleSize);
        ...
        topRightView.center = CGPointMake(_ScreenWidth - 10, self.frame.size.height - topRightView.frame.size.height - 5);
        ...
        topCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - topCenterView.frame.size.height);
...
- (void) contentOffsetChanged:(float)contentOffset {
    ...
    if (contentOffset == SpiralPullToRefreshViewTriggerAreaHeight / 2) {
        ...
        [UIView animateWithDuration:0.3
                         ...
                         animations:^{
                             bottomLeftView.center = CGPointMake((_ScreenWidth / 2) - bottomLeftView.frame.size.width - 1, self.frame.size.height - 50 + bottomLeftView.frame.size.height + 1);
                             bottomRightView.center = CGPointMake((_ScreenWidth / 2) - bottomRightView.frame.size.width - 1, self.frame.size.height - 50 - bottomRightView.frame.size.height - 1);
                             topRightView.center = CGPointMake((_ScreenWidth / 2) + topRightView.frame.size.width + 1, self.frame.size.height - 50 - topRightView.frame.size.height - 1);
                             topLeftView.center = CGPointMake((_ScreenWidth / 2) + topLeftView.frame.size.width + 1, self.frame.size.height - 50 + topLeftView.frame.size.height + 1);
                             
                             middleLeftView.center = CGPointMake((_ScreenWidth / 2) - middleLeftView.frame.size.width - 1, self.frame.size.height - 50);
                             middleRightView.center = CGPointMake((_ScreenWidth / 2) + middleRightView.frame.size.width + 1, self.frame.size.height - 50);
                             middleCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - 50);
                             topCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - 50 - topCenterView.frame.size.height - 1);
                             bottomCenterView.center = CGPointMake((_ScreenWidth / 2), self.frame.size.height - 50 + bottomCenterView.frame.size.height + 1);
                         }
        ...
        for (int i=0; i<self.particles.count; i++)
        {
            ...
            particleView.center = CGPointMake((_ScreenWidth / 2) + radius * cos (angle), self.frame.size.height - ((SpiralPullToRefreshViewTriggerAreaHeight / 2) + radius * sin(angle)));
//            NSLog(@"0000=[%f]",_ScreenWidth);
        }
