...
@property (retain, nonatomic) IBOutlet ChatTableView *messageTableView;
@property (retain, nonatomic) IBOutlet UIImageView *inputContent;
@property (nonatomic,assign)BOOL isGroupChat;

@property (retain,nonatomic) NSString* filePath;

-(void)sendButtonClick:(id)sender;
@property(nonatomic,retain) UserInfo *friendEntity;
@end
