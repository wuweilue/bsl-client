...
@property (assign,nonatomic) CubeModule *module;
...
//    [_infoLabel setText:module.releaseNote];
    ...
    if(!self.downloadButton){
        self.downloadButton = [[[InstallButton alloc] initWithFrame:CGRectMake(250,23,50,25)] autorelease];
