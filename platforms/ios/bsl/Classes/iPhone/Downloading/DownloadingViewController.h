...
@property (assign, nonatomic) id<DownloadTableDelegate> delegate;
@property (assign, nonatomic) appStatus currentShowStatus;
@property (retain, nonatomic) UIScrollView *deskTopView;
@property (retain, nonatomic) UITableView *contentTableView;
@property (retain, nonatomic) UIView *viewContainer;
@property (retain, atomic) NSMutableArray *deskTopInfoArr;
@property (retain,nonatomic) UIView *searchBarView;
@property (retain,nonatomic) NSMutableDictionary *curDic;
