...
- (void)initalizeInputView {
	...
	self.textField.textColor = [UIColor colorWithRed:0.196078 green:0.309804 blue:0.521569 alpha:1];
...
-(void)textFieldDidBeginEditing:(UITextField *)atextField{
    ...
    [[NSNotificationCenter defaultCenter]  postNotificationName:@"BeginEditTextField" object:atextField];
