...
- (void)customUI{
    [self setBackgroundImage:[UIImage imageNamed:@"segment_back.png"]];

    self.animateToInitialSelection = YES;
	self.font = [UIFont boldSystemFontOfSize:18];
    
	self.thumbEdgeInset = UIEdgeInsetsMake(0, 1, 1, 1);
    self.thumb.backgroundImage = [UIImage imageNamed:@"segment_slider_highlight.png"];
    self.thumb.highlightedBackgroundImage = [UIImage imageNamed:@"segment_slider_highlight.png"];
	self.thumb.textColor = [UIColor blueColor];
	self.thumb.textShadowColor = [UIColor colorWithWhite:1 alpha:0.2];
	self.thumb.textShadowOffset = CGSizeMake(0, 1);


//    self.cornerRadius = 7.5f;
    self.textColor = [UIColor colorWithHexString:@"0x111111"];
    self.textShadowColor = [UIColor colorWithWhite:1 alpha:0.2];
    self.height = 36;
}
...
//      self.titleEdgeInsets = UIEdgeInsetsMake(0, 10, 0, 10);
        self.titleEdgeInsets = UIEdgeInsetsMake(0, 5, 0, 10);
...
//	}
    self.segmentWidth = kSegmentWidth/[self.titlesArray count];
