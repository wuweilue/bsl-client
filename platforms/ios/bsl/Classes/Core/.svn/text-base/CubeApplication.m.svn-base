...
- (void)dealloc
{
    ...
    [version release];
    [modules release];
    [updatableModules release];
    [availableModules release];
    [downloadingModules release];
...
-(NSMutableArray *)modules{
    ...
    return [visibleModules autorelease];
}
