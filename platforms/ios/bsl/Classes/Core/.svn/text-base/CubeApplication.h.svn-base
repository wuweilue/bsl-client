...
@property(nonatomic,retain)NSMutableArray *updatableModules;
@property(nonatomic,retain)NSMutableArray *availableModules;
@property(nonatomic,retain)NSMutableArray *downloadingModules;
