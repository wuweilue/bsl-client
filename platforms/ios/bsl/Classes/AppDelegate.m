...
//    [self registerDevice];
    self.downQueueActor = [[[DownQueueActor alloc]init] autorelease];
...
-(void)showLoginView{
    ...
    {
        self.window.rootViewController = [[[Login_IphoneViewController alloc] init] autorelease];
    }else{
        ...
        [login_IpadViewController release];
    }
