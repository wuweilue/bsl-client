...
-(NSString* )getJsonFromDictioary:(NSMutableDictionary*)moduleCategoryDictionary  showHide:(Boolean)hide{
    ...
    NSString* jsonString=[Json.JSONString retain];
    [Json release];
    [pool release];
...
{
    NSMutableDictionary *moduleCategoryDictionary = [[[NSMutableDictionary alloc]init]autorelease];
