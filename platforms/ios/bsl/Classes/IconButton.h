...
@property int stauts;
@property (retain, nonatomic) IBOutlet UIView *downloadMaskView;
@property (retain, nonatomic) IBOutlet UIButton *actionButton;
@property (retain, nonatomic) IBOutlet UILabel *iconLabel;
@property (retain, nonatomic) IBOutlet UIImageView *updateableImageView;
@property (retain, nonatomic) IBOutlet AsyncImageView *iconImageView;
@property (retain, nonatomic) IBOutlet UIProgressView *downloadProgressView;
@property (copy, nonatomic) NSString *category;
@property (assign, nonatomic) id <IconButtonDelegate> delegate;
...
@property (retain, nonatomic) JSBadgeView *badgeView;
