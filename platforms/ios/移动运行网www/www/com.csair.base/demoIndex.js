define(['text!com.csair.base/demoIndex.html', 'com.csair.base/urlConfig'], function(demoIndexTemplate, UrlConfig) {
    ...
    var View = Piece.View.extend({
        ...
        //清除缓存Session.deleteObject
        deleteSession: function() {

            console.info("开始清除");

            //值班领导缓存
            Piece.Session.deleteObject('com.csair.leading-leadingList.html');
            ...
            for (var i = 0; i < mytask.length; i++) {
                Piece.Session.deleteObject('com.csair.crewmen-myselfTask.html-' + mytask[i].querySite);
            }



            //信息公告
            Piece.Session.deleteObject('com.csair.notification-notification.html-findNoticeList');
            Piece.Session.deleteObject('com.csair.notification-notification.html-warningNoticeList');
            Piece.Session.deleteObject('com.csair.notification-notification.html-findEBNoticeList');
            Piece.Session.deleteObject('com.csair.notification-notification.html-noticeCabinlist');
        ...
        gotoTodo: function() {
            this.container.navigateForResult('/com.csair.todo/index', {
                trigger: true
            }, '/com.csair.base/demoIndex', this.onGotResult);
