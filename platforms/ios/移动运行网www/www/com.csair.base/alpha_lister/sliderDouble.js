$.fn.listSliderNavDouble = function(template, CityData, CityDataI, thisIscroll) {
    ...
    cityDialogContainer['chinese'] = $(this).find('#chinese').listSliderNavFull("#chinese", {
        container: cityDialog
    }, list_iScroll_Chinese);


    list_iScroll_International = new iScroll($(this).find('#international .listSlider-content'));
    cityDialogContainer['international'] = $(this).find('#international').listSliderNavFull("#international", {
        container: cityDialog,
        listSliderHeight: cityDialogContainer['chinese'].listSliderHeight
    }, list_iScroll_International);
