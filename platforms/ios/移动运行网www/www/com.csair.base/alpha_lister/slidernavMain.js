$.fn.listSliderNavFull = function(containerId,options,thisIscroll) {
	...
	$('.listSlider-content ul li a.cityName', listSlider).click(function(e){
		...
		if($(target)[0].nodeName=='INPUT'){
			...
			$(target).text($(e.toElement).text());
		}
		options.container.hide();
		if(me.cityCallBack){
			me.cityCallBack.call();
		}
	...
	$(containerId).hide();
	var sliderObject = {
		show:function(){$(containerId).show();thisIscroll.refresh();},
