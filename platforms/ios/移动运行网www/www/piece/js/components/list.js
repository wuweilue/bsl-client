 ...
 *
 */
define(['zepto', 'underscore', 'components/loader', 'components/cache', 'components/store', 'gmu', 'backbone', 'components/reloginAjax'],
    


    function($, _, Loader, Cache, Store, gmu, Backbone,Relogin) {
        ...
        var List = Backbone.View.extend({
            ...
            setRequestParams: function(params, callback) {
            ...
            loadNextPage: function(callback) {
                ...
                Relogin.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        ...
                        console.log("cube---list---" + recordsCount + ' records in total');
