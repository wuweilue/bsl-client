...
define(['zepto','components/fixed', 'canvasloader'], function($,Fixed,MyCanvasLoader){
    var me;
    ...
    var Loader = function(config){
        this.config = {autoshow : true, target: 'body',text:"正在加载中...",cancelable:true,warnningTime:3000};
        canceled = false;
        if(config) {
...
// 暂时不需要     img.attr('src','data:image/png;base64,');
        ...
        setTimeout(function(){
            if(text){
                    text.text("网络缓慢,请耐心等待");
                    text.show();
                }

        },this.config.warnningTime);
        
        loader.append(img);
        loader.append(box);

        
        var canLoader = $("<div/>").addClass('cube-flight-loader-face');
        box.append(canLoader);
        var cl = new CanvasLoader($(canLoader)[0]);
